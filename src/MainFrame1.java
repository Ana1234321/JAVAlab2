    ...
    private void addRadioButton(String buttonName, final int formulaId) {
        ...
        button.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ev) {
                ...
                if (formulaId == 1)	imageLabel.setIcon(new ImageIcon(MainFrame1.class.getResource("Formula_1.png")));
                if (formulaId == 2) imageLabel.setIcon(new ImageIcon(MainFrame1.class.getResource("Formula_2.png")));
            }
        });
...
//hboxFormulaType.setBorder(BorderFactory.createLineBorder(Color.YELLOW));
        ...
        imageLabel = new JLabel(new ImageIcon(MainFrame1.class.getResource("formula_1.bmp")));
        ...
        buttonCalc.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ev) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(MainFrame1.this, "Ошибка в" +
